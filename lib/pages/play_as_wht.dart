...
//import 'package:gambit/pages/stockfish_fen.dart';
//import 'package:gambit/services/stockfish.dart';
//import 'package:gambit/pages/stockfish_fen.dart';

class Gamestart extends StatefulWidget {
  const Gamestart(this.depth, this.time, {super.key});
  final int depth;
  final int time;
...
class _GamestartState extends State<Gamestart> with TickerProviderStateMixin {
  ...
  void handleMove(String fen, ChessBoardController controller) async {
    ...
    String? bestMove = await getBestMove(fen, widget.depth, widget.time);
    print(bestMove);
    // Check if promotion
